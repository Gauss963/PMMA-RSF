...
```bash
python scripts/run_case.py cases/rsf_0124_q4_vs30_long_transition_12h.toml --preflight
```

Launch locally:

```bash
python scripts/run_case.py cases/rsf_0124_q4_vs30_long_transition_12h.toml
```
