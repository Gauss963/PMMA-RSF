...
```bash
python scripts/run_case.py cases/rsf_0123_q4_uniform_leading_slow_12h.toml --preflight
```

Launch locally:

```bash
python scripts/run_case.py cases/rsf_0123_q4_uniform_leading_slow_12h.toml
```
